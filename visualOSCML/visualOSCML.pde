...
{ background(0);
  if((average1 > highLim) && (average2 < lowLim) && (average3 < lowLim)  && (average4 < lowLim)) {
    ...
    fill(decay1,0,0);
    rect(width/5, height/2, width/7, height*0.9, 7);
    fill(0,decay2,0);
    rect(2*width/5, height/2, width/7, height*0.9, 7);
    fill(0,0,decay3);
    rect(3*width/5, height/2, width/7, height*0.9, 7); 
    fill(decay4, 0, decay4);
    rect(4*width/5, height/2, width/7, height*0.9, 7);
}
